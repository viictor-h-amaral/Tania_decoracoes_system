...
{
    public class TiposEventosPageViewModel : ViewModelBase
    {
        ...
        public TiposEventosPageViewModel()
        {
            var gridConfig = new GridConfigObject(  title: "Tipos de eventos",
                                                    readOnly: true,
                                                    autoGenerateColumns: true,
                                                    (DefaultActionButtons.All)); 

            DataGridVM = new CommonDataGridViewModel<TipoEvento>(gridConfig) { };
