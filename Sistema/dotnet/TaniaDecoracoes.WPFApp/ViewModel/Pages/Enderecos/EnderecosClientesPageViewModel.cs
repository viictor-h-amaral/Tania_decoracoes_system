...
{
    public class EnderecosClientesPageViewModel : ViewModelBase
    {
        ...
        public EnderecosClientesPageViewModel()
        {
            ...
            DataGridVM = new CommonDataGridViewModel<EnderecoCliente>(gridConfig) { };
