...
{
    public class TiposLogradourosPageViewModel : ViewModelBase
    {
        ...
        public TiposLogradourosPageViewModel()
        {
            var gridConfig = new GridConfigObject(title: "Tipos de logradouros",
                                                    readOnly: true,
                                                    autoGenerateColumns: true,
                                                    (DefaultActionButtons.All));

            DataGridVM = new CommonDataGridViewModel<TipoLogradouro>(gridConfig) { };
